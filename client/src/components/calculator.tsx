...
export const Calculator = () => {
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      <h1 className="text-3xl font-bold text-primary mb-6 text-center">NIRF Score Calculator</h1>
      <div className="bg-white/50 backdrop-blur-sm rounded-lg p-6 mb-8">
        <p className="text-center text-neutral-600 mb-6">
          Enter your scores below to calculate your institution's NIRF ranking score
        </p>
